...
C_SRCS += \
../Src/adc_read_simple.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/adc_read_simple.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/adc_read_simple.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
Src/adc_read_simple.o: ../Src/adc_read_simple.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F4 -DSTM32F446RETx -DDEBUG -c -I../Inc -I"C:/Users/rahul/Desktop/Dev_Projects/Embedded/stm32CubeIDE/stm32f446xx/Drivers/Src" -I"C:/Users/rahul/Desktop/Dev_Projects/Embedded/stm32CubeIDE/stm32f446xx/Drivers/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/adc_read_simple.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
